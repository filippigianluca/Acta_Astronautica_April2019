...
if flag_input_list == 1
    %% u max mass
    load('ebro_IAC_constr_SO_nfeval_decomposition_MASS1000_umaxMASS.mat');
    LIST_F1 = LIST.table;
    load('ebro_IAC_constr_SO_nfeval_decomposition_RES1000_umaxMASS.mat');
    LIST_F2 = LIST.table;
    
elseif flag_input_list == 2
    %% u min Volume
    load('ebro_IAC_constr_SO_nfeval_decomposition_MASS1000_umaxRES.mat');
    LIST_F1 = LIST.table;
    load('ebro_IAC_constr_SO_nfeval_decomposition_RES1000_umaxRES.mat');
    LIST_F2 = LIST.table;
    
elseif flag_input_list == 3
    %% two samples: u max mass AND u min Volume
    load('ebro_IAC_constr_SO_nfeval_decomposition_2samples1000.mat');
    LIST_F1 = LIST.table;
    load('ebro_IAC_constr_SO_nfeval_decomposition_RES_2samples1000.mat');
    LIST_F2 = LIST.table;
...
%%%%
if ~isempty(nrc)
max_FE_fun1 = max_FE_fun1(nrc);
max_FE_fun2 = max_FE_fun2(nrc);
bpa_FE_fun1 = bpa_FE_fun1(nrc);
bpa_FE_fun2 = bpa_FE_fun2(nrc);
end
%%%%
