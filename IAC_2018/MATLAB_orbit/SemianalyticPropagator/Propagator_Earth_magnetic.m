...
h_crossing = [110 125 150 250 350 500 700 1000 1500 2000 2500 384000];
h_crossing = h_crossing / constants.DU;

% Load coefficients
% load Chebyshev_coefficients.mat
%load Chebyshev_coefficients_110km.mat
load Chebyshev_110km_1000km_MSIS_high.mat
...
if num_comparison
    ...
    [T_Numeric, Equin_Numeric] = ode45(@(t,x)equations_motion3(t, x, input_num_int, thrust, control, drag, constants.g0),...
