//  Action_calculator_forces2_torques2_massive_point_adimentional.c
//
//  Created by Lorenzo Teofili on 14/10/15.
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Action_calculator_forces2_torques2_massive_point_adimentional computes
...
//        6.0/8640.0,3.0/8640.0,3.0/8640.0,3.0/8640.0,3.0/8640.0,6.0/8640.0,
  ...
  //  };
    ...
    Fa[0] = 6*rho_a*M_b*Fa[0];
    Fa[1] = 6*rho_a*M_b*Fa[1];
    Fa[2] = 6*rho_a*M_b*Fa[2];
    
    E_m[0] = 6*rho_a*M_b/R3*E_m[0];  // it works, it is the traspost
    E_m[3] = 6*rho_a*M_b/R3*E_m[3];
    E_m[6] = 6*rho_a*M_b/R3*E_m[6];
    E_m[1] = 6*rho_a*M_b/R3*E_m[1];
    E_m[4] = 6*rho_a*M_b/R3*E_m[4];
    E_m[7] = 6*rho_a*M_b/R3*E_m[7];
    E_m[2] = 6*rho_a*M_b/R3*E_m[2];
    E_m[5] = 6*rho_a*M_b/R3*E_m[5];
    E_m[8] = 6*rho_a*M_b/R3*E_m[8];
