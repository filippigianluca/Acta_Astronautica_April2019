...
% Adimensional initial conditions: x0, y0, vx0, vy0 (IC for DRO)
pos0_vel0 = [1.235730563909383, 0, 0,  -0.556662961164044];
...
% Numerical integration
[x,y,vx,vy,t] = CR3BPIntegration2_adim(pos0_vel0(1,1), pos0_vel0(1,2), pos0_vel0(1,3), ...
    pos0_vel0(1,4), ...
    linspace(0,2*ToF,100), Earth, Moon, L_star, T_star);


%% Plot
figure
plot(x*L_star,y*L_star,'k')
hold on
