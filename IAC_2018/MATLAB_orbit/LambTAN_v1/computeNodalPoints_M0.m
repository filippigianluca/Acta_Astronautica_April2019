...
tmp_vec = cross(r1, v1);
angular_moment_orb1 = tmp_vec/norm(tmp_vec);

% Direction of the Angular momentum
tmp_vec = cross(r2, v2);
angular_moment_orb2 = tmp_vec/norm(tmp_vec);
...
sin_om_node = norm(cross(asc_vec,x0'))/(norm(asc_vec)*norm(x0));
