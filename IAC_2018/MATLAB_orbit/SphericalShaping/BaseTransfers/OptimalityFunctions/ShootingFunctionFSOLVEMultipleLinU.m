function [FunVal] = ShootingFunctionFSOLVEMultipleLinU(y,inCond,fCond,mu,timeInt,M,nT,uMax)

%OptContFunctionFSOLVE (Optimal Control Function for fsolve)
...
for i=1:M 
    ...
    %Y = Y';
     ...
     %%% Rk 4, n steps %%%
     timeInteg = linspace(timeInt(i),timeInt(i+1),nT+1);
     [tt,Y] = rk4(@diffEqLinU,timeInteg,y(:,i),1,mu,uMax);
     Y = Y';
