function  plotTrajectoryMultBodiesSpherNoCont(DepBody,ArrivalBody,depDate,arrDate,thetalegs,Rlegs,Philegs)
...
% bodies
% thetalegs,Rlegs,Philegs: matrices containing the values of theta,R,Phi
...
for i=1:4
    ...
    % Plot the transfer
    plot3(Xt,Yt,Zt,'w','LineWidth',2.0);
...
%Plot axes
lim = 7;
line([0 lim], [0 0], [0 0]); text(lim, 0, 0, 'X','Color','blue');
line( [0 0], [0 lim], [0 0]); text( 0, lim, 0, 'Y','Color','blue');
line( [0 0], [0 0], [0 lim]); text( 0, 0, lim, 'Z','Color','blue');
