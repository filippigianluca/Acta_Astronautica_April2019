function [thetaVec,R,Phi,u_mat,DV,isLoopConverged,cont,TPrime1,Ucart,Vcart] = SphericalShapingWithFSolve(DepBody,ArrBody,t_dep,TOF,nr,toll,thetaStep,a2,Vinf,alpha,beta)
%28/09/15
