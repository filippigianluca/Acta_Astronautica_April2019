function [Delta_V, T_Analytic, Kep_Analytic] = Burt_a0_e0_omega(initial_orbit, final_orbit, time_int, engine, m0, element_target, constants)
...
r_belt = 0;
T_Sun_adim = 0;
T_adim = T * 1e-3 / constants.DU  * constants.TU^2*0;
t0 = 0;
...
thrust.thrust_t = 0;
thrust.beta_rth = 0;
thrust.alpha_rth = alfa;
thrust.thrust_rth = T * 1e-3 / constants.DU  * constants.TU^2;
