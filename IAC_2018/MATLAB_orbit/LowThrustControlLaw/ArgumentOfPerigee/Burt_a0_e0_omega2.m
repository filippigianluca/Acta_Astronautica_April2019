function [Delta_V, T_Analytic, Kep_Analytic] = Burt_a0_e0_omega2(initial_orbit, final_orbit, time_int, engine, m0, element_target, constants)
...
if sign(engine.f) == 1
    ...
    control.alfa_p = 3/2*pi*ones(n,1);
    control.alfa_a = pi/2*ones(n,1);
end
