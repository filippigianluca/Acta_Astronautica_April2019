function [DV,TIME] = BinormalControl_2(DepElements,ArrElements,range,p,mu,du_i_h,du_others)

%% Define useful parameters
a0= p(1); a1= p(2); a2= p(3); e0 = p(4); e1 = p(5); e2 = p(6); w0=p(7);
w1 = p(8); w2 = p(9); G0 = p(10); G1 = p(11) ; G2 = p(12); G3 = p(13);

u_0 = DepElements(4); u_f = ArrElements(4) ;

r = @(u) ( ( a0 + a1 .* ( u - u_0 ) + a2 .* sin( u - u_0 ) ) .* ( 1 - ( e0 + e1 .* ( u - u_0 ) + e2 .* sin( u - u_0 ) ) .^ 2 ) )./( 1 + ( e0 + e1 .* ( u - u_0 ) + e2 .* sin( u - u_0 ) ) .* ( cos( w0 + w1 .* ( u - u_0 ) + w2 .* sin( u - u_0 ) ) .* cos(u) + sin( w0 + w1 .* ( u - u_0 ) + w2 .* sin( u - u_0 ) ) .* sin(u) ) );
dr = @(u) a2 .* cos(u - u_0) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) - 0.2e1 .* (a0 + a2 .* sin(u - u_0)) .* (e0 + e2 .* sin(u - u_0)) .* e2 .* cos(u - u_0) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) - (a0 + a2 .* sin(u - u_0)) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) .^ 2 .* (e2 .* cos(u - u_0) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u)) + (e0 + e2 .* sin(u - u_0)) .* (-w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + sin(w0 + w2 .* sin(u - u_0)) .* cos(u)));
drr = @(u) -a2 .* sin(u - u_0) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) - 0.4e1 .* a2 .* cos(u - u_0) .^ 2 .* (e0 + e2 .* sin(u - u_0)) .* e2 ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) - 0.2e1 .* a2 .* cos(u - u_0) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) .^ 2 .* (e2 .* cos(u - u_0) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u)) + (e0 + e2 .* sin(u - u_0)) .* (-w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + sin(w0 + w2 .* sin(u - u_0)) .* cos(u))) - 0.2e1 .* (a0 + a2 .* sin(u - u_0)) .* e2 .^ 2 .* cos(u - u_0) .^ 2 ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) + 0.2e1 .* (a0 + a2 .* sin(u - u_0)) .* (e0 + e2 .* sin(u - u_0)) .* e2 .* sin(u - u_0) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) + 0.4e1 .* (a0 + a2 .* sin(u - u_0)) .* (e0 + e2 .* sin(u - u_0)) .* e2 .* cos(u - u_0) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) .^ 2 .* (e2 .* cos(u - u_0) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u)) + (e0 + e2 .* sin(u - u_0)) .* (-w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + sin(w0 + w2 .* sin(u - u_0)) .* cos(u))) + 0.2e1 .* (a0 + a2 .* sin(u - u_0)) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) .^ 3 .* (e2 .* cos(u - u_0) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u)) + (e0 + e2 .* sin(u - u_0)) .* (-w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + sin(w0 + w2 .* sin(u - u_0)) .* cos(u))) .^ 2 - (a0 + a2 .* sin(u - u_0)) .* (0.1e1 - (e0 + e2 .* sin(u - u_0)) .^ 2) ./ (0.1e1 + (e0 + e2 .* sin(u - u_0)) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u))) .^ 2 .* (-e2 .* sin(u - u_0) .* (cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + sin(w0 + w2 .* sin(u - u_0)) .* sin(u)) + 0.2e1 .* e2 .* cos(u - u_0) .* (-w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) + sin(w0 + w2 .* sin(u - u_0)) .* cos(u)) + (e0 + e2 .* sin(u - u_0)) .* (w2 .* sin(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* cos(u) - w2 .^ 2 .* cos(u - u_0) .^ 2 .* cos(w0 + w2 .* sin(u - u_0)) .* cos(u) + 0.2e1 .* w2 .* cos(u - u_0) .* sin(w0 + w2 .* sin(u - u_0)) .* sin(u) - cos(w0 + w2 .* sin(u - u_0)) .* cos(u) - w2 .* sin(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* sin(u) - w2 .^ 2 .* cos(u - u_0) .^ 2 .* sin(w0 + w2 .* sin(u - u_0)) .* sin(u) + 0.2e1 .* w2 .* cos(u - u_0) .* cos(w0 + w2 .* sin(u - u_0)) .* cos(u) - sin(w0 + w2 .* sin(u - u_0)) .* sin(u)));
...
if U(1,1) > u_0+1e-3
    ...
    dr_step = dr(UIntervalStep);
    ddr_step = drr(UIntervalStep);
...
for ii = 1:ll
    ...
    elseif i_or_h(ii) == 1
        ...
        F_n_Step = @(u) (h1 + 2 .* h2 .* (u - u0) + 3 .* h3 .* (u - u0) .^ 2) .* (G0 + G1 .* (u - u_0) + G2 .* sin(u - u_0 + G3)) .^ 2 ./ r(u) .^ 3 ./ (sin(u) ./ sin(InitialIncStep) + cot(InitialIncStep) .* sin(u) .* (h1 + 2 .* h2 .* (u - u0) + 3 .* h3 .* (u - u0) .^ 2));       
