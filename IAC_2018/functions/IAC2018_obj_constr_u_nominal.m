...
function output = IAC2018_obj_constr_u_nominal(d, u, par) 
...
ep_power(7) = u(13);   %       * ep(7)  = uncertainty on array temperature, C                    (ALICINO uncertain, [0 10][10 15])
...
P_payload_imaging = P_payload_imaging*1.2;
P_payload_idle    = P_payload_idle*1.2;
% info_payload.N_images_to_compress_and_store = info_payload.N_images_to_compress_and_store*1.2;
% info_payload.N_images_tot = info_payload.N_images_tot*1.2;
% info_payload.Data_Volume_to_compress_and_store = info_payload.Data_Volume_to_compress_and_store*1.2;
% info_payload.Data_Volume_tot = info_payload.Data_Volume_tot*1.2;
%--------------------------------------------------------------------------
...
P_obdh                     = P_obdh*1.2;
% info_obdh.V_compressed_tot = info_obdh.V_compressed_tot*1.2;
%--------------------------------------------------------------------------
% 
% 
% 
...
%% output
%--------------------------------------------------------------------------
output.f = (M_payload + M_obdh + M_aocs + M_ttc + M_power)*1.2;
