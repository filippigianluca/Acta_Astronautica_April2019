...
function [F] = CUBESAT_5subsystems_MASS(d, u, par) 
...
ep_ttc(8) = info_payload.Tac_tot*60;                %       * ep(8) = ground station access time, min         
...
% d_ = [d_; d];
% Mass = [Mass F];
% Mpayload = [Mpayload M_payload];
% Mobdh = [Mobdh M_obdh];
% Maocs = [Maocs M_aocs];
% Mttc = [Mttc M_ttc];
% Mpower = [Mpower M_power];
