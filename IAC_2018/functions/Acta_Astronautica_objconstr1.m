function output = Acta_Astronautica_objconstr1(d, u, par) 
...
R1_max = max(info_payload.R1_vector);
R2_max = max(info_payload.R2_vector);
...
RES = resilienceSimpleFunction(TM,R2_max,R1_max,lam, mu);
%--------------------------------------------------------------------------
...
%% output
%--------------------------------------------------------------------------
output.f = M_payload + M_obdh + M_aocs + M_ttc + M_power;
