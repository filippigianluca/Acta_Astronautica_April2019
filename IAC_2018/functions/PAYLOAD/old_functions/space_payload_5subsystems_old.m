...
info.t_day   = T_orbit - ECL; % hours
info.t_night = ECL;           % hours
%--------------------------------------------------------------------------
...
beta0_dI = beta0*cosd(delta_I/100*90);
...
%     T(ind_k) = dt;
% %     if tt_sec > T_orbit
%         N_images_vector(ind_k) = floor(info.frame_rate*T_orbit*(1-dt/T_orbit));
% %     else
% %         N_images_vector(ind_k) = floor(info.frame_rate*T_ac_more);
% %     end
% 
%     
% end
