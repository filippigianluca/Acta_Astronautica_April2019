...
function [F] = IAC_function(d, u, par) 
...
% Payload: camera
%--------------------------------------------------------------------------
[M_payload, P_payload_imaging, P_payload_idle, info_payload] = IAC_payload(x_payload, ep_payload, par_payloads);
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
[M_obdh, P_obdh, info_obdh] =  IAC_obdh(x_obdh, ep_obdh);
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
[M_aocs, P_aocs, info_aocs] = IAC_aocs(x_aocs, ep_aocs);
...
[M_ttc, P_ttc, info_ttc] = IAC_ttc(x_ttc,ep_ttc);
%--------------------------------------------------------------------------
...
[M_power, P_power, info_power] = IAC_power(x_power,ep_power);
%--------------------------------------------------------------------------
