function [algo_minmax, algo_outer, algo_inner] = init_algo_mso(minmax_problem);
...
if (minmax_problem.n_obj == 1)
    ...
    algo_outer.optimise = @optimise_mpaidea_wrapper;          % algorithm in the form [x,f,exitflag,output] = algo(problem,par_algo)
        par_mpaidea.nFeValMax = 200*minmax_problem.dim_d;     % number of function evaluations for IDEA
