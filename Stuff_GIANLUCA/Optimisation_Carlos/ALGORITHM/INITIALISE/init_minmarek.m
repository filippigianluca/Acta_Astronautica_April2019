...
% parameters
    ...
    par_minmax.tol_conv = 1e-4; %Tolerance to convergence, only used in S.O. case
    par_minmax.indicator_d_max = 1e-4; % Threshold on the indicator (EI, PI, etc.) for outer loop
    par_minmax.indicator_u_max = 1e-4; % Threshold on the indicator (EI, PI, etc.) for inner loop
