function [algo_minmax, algo_outer, algo_inner] = init_algo_mo_noncon(minmax_problem);
...
% parameters
    if isfield(minmax_problem,'maxnfeval')
        par_minmax.maxnfeval = 5*minmax_problem.maxnfeval;% TOTAL function evaluation limit
    else
