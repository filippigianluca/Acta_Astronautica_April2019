function [algo_minmax, algo_outer, algo_inner] = init_algo_so_ausa_tc6(minmax_problem);
...
% parameters
    ...
    par_minmax.maxnfeval = 3e5;% TOTAL function evaluation limit
...
obj = 1;
    ...
    par_mpaidea = struct;
        par_mpaidea.nFeValMax = 5e2*minmax_problem.dim_u;     % number of function evaluations for IDEA
        par_mpaidea.n_populations = 1;                        % number of populations, if no adaptive behaviour should set to 1
