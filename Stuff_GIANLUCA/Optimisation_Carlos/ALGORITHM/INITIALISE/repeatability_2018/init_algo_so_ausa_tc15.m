function [algo_minmax, algo_outer, algo_inner] = init_algo_so_ausa_tc15(minmax_problem);
...
% parameters
    ...
    par_minmax.maxnfeval = 5e5  ;% TOTAL function evaluation limit
...
obj = 1;
    ...
    par_mpaidea = struct;
        ...
        par_mpaidea.n_populations = 1;                        % number of populations, if no adaptive behaviour should set to 1
        par_mpaidea.n_agents = 20;                            % number of agents in one population
        par_mpaidea.population=[];                            % initial population, same for all execution. Leave empty to randomize.
