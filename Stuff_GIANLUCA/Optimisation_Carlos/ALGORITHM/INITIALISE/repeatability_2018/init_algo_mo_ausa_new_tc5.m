function [algo_minmax, algo_outer, algo_inner] = init_algo_mo_ausa_new_tc5(minmax_problem);
...
% parameters
    if isfield(minmax_problem,'maxnfeval')
        par_minmax.maxnfeval = 4e5;% TOTAL function evaluation limit
    else
...
%% ALGORITHM OUTER LOOP with archive cross-checks
    ...
    %parameters{
        par_macs = struct;
        par_macs.maxnfeval = 80*minmax_problem.dim_d;      % Max function evaluations
