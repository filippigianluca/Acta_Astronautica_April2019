function [algo_minmax, algo_outer, algo_inner] = init_algo_so_ausa_tc8(minmax_problem);
...
% parameters
    ...
    par_minmax.maxnfeval = 3e3;% TOTAL function evaluation limit
...
if (minmax_problem.n_obj == 1)
    ...
    algo_outer.optimise_au = @optimise_mpaidea_wrapper;       % algorithm in the form [x,f,exitflag,output] = algo(problem,par_algo)
        par_mpaidea.nFeValMax = 50*minmax_problem.dim_d;     % number of function evaluations for IDEA
