function [algo_minmax, algo_outer, algo_inner] = init_algo_mo_ausa_new_tc4(minmax_problem);
...
obj = 1;
    ...
    par_mpaidea = struct;
        par_mpaidea.nFeValMax = 4e2*minmax_problem.dim_u;     % number of function evaluations for IDEA
        par_mpaidea.n_populations = 1;                        % number of populations, if no adaptive behaviour should set to 1
