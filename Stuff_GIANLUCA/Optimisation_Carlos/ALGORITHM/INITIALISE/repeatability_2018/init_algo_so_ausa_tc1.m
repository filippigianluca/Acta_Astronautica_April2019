function [algo_minmax, algo_outer, algo_inner] = init_algo_so_ausa_tc1(minmax_problem);
...
% parameters
    ...
    par_minmax.maxnfeval = 1e4;% TOTAL function evaluation limit
    ...
    par_minmax.alternate_outer = true;   % if alternate, will alternate in outer loop the methods
