function [algo_minmax, algo_outer, algo_inner] = init_algo_so_nested_local_psi(minmax_problem);

%% META ALGORITHM: MACSMINMAX
algo_minmax.optimise = @optimise_nested_psi;            % algorithm in the form [x,f,exitflag,output] = algo(problem,algo_outer,algo_inner,par_minmax)
% parameters
...
if (minmax_problem.n_obj == 1)
    ...
    %parameters{
        par_macs.maxnfeval = minmax_problem.nfouter_nested*minmax_problem.dim_d;;                  % Max function evaluations
