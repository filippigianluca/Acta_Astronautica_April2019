function [algo_minmax, algo_outer, algo_inner] = init_algo_mo_ausa_ego(minmax_problem);
...
% parameters
    ...
    par_minmax.n_u0 = max(10,3*minmax_problem.dim_u);
    ...
    cc_opt = struct;
        ...
        cc_opt.ls_flag_crosscheck = 2;        % 0 for no local search, 1 for local search from the argmax. in Au, 2 for local search at every cross-check
