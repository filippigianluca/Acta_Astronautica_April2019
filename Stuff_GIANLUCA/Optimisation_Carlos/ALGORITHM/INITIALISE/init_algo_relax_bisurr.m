function [algo_minmax, algo_outer, algo_inner] = init_algo_relax_bisurr(minmax_problem);

%% META ALGORITHM: MACSMINMAX
algo_minmax.optimise = @optimise_relax_bisurr;            % algorithm in the form [x,f,exitflag,output] = algo(problem,algo_outer,algo_inner,par_minmax)
% parameters
    ...
    par_minmax.n_d0 = 4*minmax_problem.dim_d;
