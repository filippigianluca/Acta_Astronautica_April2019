...
f = func(d_true,u_true,par_func);
masked = -par_objfun.sign*f;

% % archiving: necessary for variance-based decomposition with analysis of opt. sample

% global f_history;
% if obj == 2
% 	f_history = [f_history; u_true, f];
% end
