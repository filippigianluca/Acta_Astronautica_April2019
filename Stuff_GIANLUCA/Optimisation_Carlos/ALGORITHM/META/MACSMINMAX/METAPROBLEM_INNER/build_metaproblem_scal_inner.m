function [metaproblem] = build_metaproblem_scal_inner(problem,lambdas,utopia,frontspans)

metaproblem.par_objfun.lambdas = lambdas;
metaproblem.par_objfun.utopia = utopia;
metaproblem.par_objfun.frontspans = frontspans;
...
metaproblem.objfun = @mask_objfun_scal_inner; % depends on u and par_objfun. Needs to specify par_objfun.d and par_objfun.objective
