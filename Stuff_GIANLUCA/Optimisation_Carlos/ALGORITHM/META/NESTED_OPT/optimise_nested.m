function [d,fval,exitflag,output] = optimise_nested(problem_minmax, algo_outer, algo_inner, par_minmax)
...
problem_outer = build_metaproblem_nested_outer(problem_inner, algo_inner);
