function [metaproblem] = build_metaproblem_nested_inner(problem)
...
metaproblem.objfun = @mask_objfun_nested_inner; % depends on u and par_objfun. Needs to specify par_objfun.d and par_objfun.objective
