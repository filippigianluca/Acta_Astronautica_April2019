...
for runid = 1:20
    for tc = [1 2]
        ...
        disp(strcat('S_',num2str(tc),'_',num2str(runid)))
        global nfevalglobal;
        nfevalglobal = 0;
        ...
        %% initialise problem 
        [ problem_minmax ] = init_tc_so_nonconvex(tc);
        
        %% ONLY FOR BENCHMARK REPEATABILITY PURPOSES! {{{
            %init = str2func(strcat('init_algo_so_ausa_tc',num2str(tc)));
            init = str2func('init_algo_so_ausa_ego');
        %% }}}
