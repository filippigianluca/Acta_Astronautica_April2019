function [algo_minmax, algo_outer, algo_inner] = init_algo_so_sstl_corners(minmax_problem);
...
algo_inner.optimise = @optimise_sstl;          % algorithm in the form [x,f,exitflag,output] = algo(problem,par_algo)
algo_inner.minimise = @minimise_sstl;
