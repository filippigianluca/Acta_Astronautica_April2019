...
switch (id)
    case 1
        ...
        problem_minmax.maxnfeval = 2e4;
        problem_minmax.maxnfeval_eff = 5e3;
    ...
    case 4
        ...
        % maxnfeval: optional to give it here or in the algorithm
        problem_minmax.maxnfeval = 1e5;
        problem_minmax.maxnfeval_eff = 8e4;
