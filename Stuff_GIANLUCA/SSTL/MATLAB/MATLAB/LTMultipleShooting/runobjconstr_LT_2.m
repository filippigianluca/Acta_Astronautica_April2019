function [x, f, eflag, outpt] = runobjconstr_LT_2(x0,parameters,options,constants,A,b,LB,UB)
...
[x,f,eflag,outpt] = fmincon(fun,x0,A, b, [], [], LB, UB,cfun,options.options_fmincon);
    ...
    function [y,myGf] = objfun(x)
        if ~isequal(x,xLast) % Check if computation is necessary
            [myf,myc,myceq] =  cost_constraint_gradients_LT_2(x, parameters, options, constants);
