function [myf,myc,myceq] =  cost_constraint_gradients_LT(x, parameters, options, constants)
...
[J,C,Ceq,GCeq] = cost_constraint_function_LT(x, parameters, options, constants);
