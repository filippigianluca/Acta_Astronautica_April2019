function  plotTrajectoryCartesianState(DepBody,ArrBody,t_dep,TOF,R,Ucart)

% plotTrajectoryCartesianState
% Function for plotting the low-thrust trajectory given the Departure and
% Arrival bodies parameters and the position vector in cartesian
% coordinates of the spacecraft
%
% INPUT
% DepBody,ArrBody: structures for Departure and Arrival bodies containing
% their orbital parameters
% t_dep: departure time
% TOF: time of flight
% R: matrix with the positon (n x 3)
% Ucart: matrix with the control (3 x n)
