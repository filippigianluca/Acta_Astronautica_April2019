...
fprintf('EphSS: ');
str = ['mex src' dash 'mexEphSS.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('EphSS_kep: ');
str = ['mex src' dash 'mexEphSS_kep.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('moon_eph: ');
str = ['mex src' dash 'mexMoon_eph.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('NeoEphemeris: ');
str = ['mex src' dash 'mexNeoEphemeris.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('uplanet: ');
str = ['mex src' dash 'mexUplanet.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('astroConstants: ');
str = ['mex src' dash 'mexAstro_constants.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
...
fprintf('d2b_eq: ');
str = ['mex src' dash 'mexD2b_eq.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_m: ');
str = ['mex src' dash 'mexD2b_eq_m.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_mvarIsp: ');
str = ['mex src' dash 'mexD2b_eq_mvarIsp.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_Ttmod: ');
str = ['mex src' dash 'mexD2b_eq_Ttmod.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_u: ');
str = ['mex src' dash 'mexD2b_eq_u.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_u2: ');
str = ['mex src' dash 'mexD2b_eq_u2.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d2b_eq_utmod: ');
str = ['mex src' dash 'mexD2b_eq_utmod.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d3b_eq_PlanetSun_m: ');
str = ['mex src' dash 'mexD3b_eq_PlanetSun_m.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('d4b_eq_EarthSunMoon_wsb: ');
str = ['mex src' dash 'mexD4b_eq_EarthSunMoon_wsb.c src' dash 'dynamics.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
...
str = ['mex src' dash 'mexDv_insertion.c src' dash 'orbital_transfers.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
fprintf('semiperiod_hohm: ');
str = ['mex src' dash 'mexSemiperiod_hohm.c src' dash 'orbital_transfers.c src' dash 'ephemerides.c src' dash 'conversions.c src' dash 'astroConstants.c src' dash 'math_utils.c -outdir ' outputDir ' -DMEXCOMPILE'];
eval(str)
fprintf('done\n');
