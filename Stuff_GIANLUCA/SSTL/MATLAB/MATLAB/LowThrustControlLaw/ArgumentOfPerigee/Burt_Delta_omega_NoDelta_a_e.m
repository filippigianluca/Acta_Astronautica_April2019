...
% First case. 
% FABLE computes an integration with radial component equal to the
% acceleration constant on the entire orbit. 
...
[Delta_V_analytic, T_Analytic, Kep_Analytic] = Burt_a0_e0_omega(initial_orbit, final_orbit, time_int, engine, m0, element_target, constants);

omega_analytic = initial_orbit.omega +  ...
    sqrt(initial_orbit.a * (1 - initial_orbit.e^2) / constants.mu_dim) * ...
    engine.T/m0 * 1e-3 * Time;
