function [algo_inner, algo_outer, algo_minmax, algo_decomposition] = def_optimiser_SSTL(problem)
...
% algo inner
algo_inner.save_pop_DE = flag_inner;
algo_inner.save_local_search = flag_inner;
...
% algo outer
algo_outer.save_pop_DE = flag_outer;
algo_outer.save_local_search = flag_outer;
algo_outer.save_pop_LR = 0;
algo_outer.save_pop_GR = 0;

% algo constraint
algo_inner.con.save_pop_DE = flag_constr;
algo_inner.con.save_local_search = flag_constr;
